-- Add missing metadata templates
INSERT INTO metadata_templates (id, name, description, metadata_standard, metadata_version, schema_type, template_xml)
VALUES
    (2, 'INSPIRE Metadata', 'INSPIRE metadata template for spatial data', 'ISO19115', '1.0', 'INSPIRE', '<?xml version="1.0" encoding="UTF-8"?>
<gmd:MD_Metadata xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco">
    ...
    <gmd:dataQualityInfo>
        <gmd:DQ_DataQuality>
            <gmd:scope>
                <gmd:DQ_Scope>
                    <gmd:level>
                        <gmd:MD_ScopeCode codeList="http://standards.iso.org/ittf/PubliclyAvailableStandards/ISO_19139_Schemas/resources/codelist/ML_gmxCodelists.xml#MD_ScopeCode" codeListValue="{{inspireResourceType}}">{{inspireResourceType}}</gmd:MD_ScopeCode>
                    </gmd:level>
                </gmd:DQ_Scope>
            </gmd:scope>
            <gmd:report>
                    ...
                    <gmd:result>
                        <gmd:DQ_ConformanceResult>
                            <gmd:specification>
                                <gmd:CI_Citation>
                                    <gmd:title>
                                        <gco:CharacterString>{{inspireSpecificationTitle}}</gco:CharacterString>
                                    </gmd:title>
                                    <gmd:date>
                                        <gmd:CI_Date>
                                            <gmd:date>
                                                <gco:Date>{{inspireSpecificationDate}}</gco:Date>
                                            </gmd:date>
                                            <gmd:dateType>
                                                <gmd:CI_DateTypeCode codeList="http://standards.iso.org/ittf/PubliclyAvailableStandards/ISO_19139_Schemas/resources/codelist/ML_gmxCodelists.xml#CI_DateTypeCode" codeListValue="{{inspireSpecificationDateType}}">{{inspireSpecificationDateType}}</gmd:CI_DateTypeCode>
                                            </gmd:dateType>
                                        </gmd:CI_Date>
                                    </gmd:date>
                                </gmd:CI_Citation>
                            ...
                            <gmd:explanation>
                                <gco:CharacterString>{{inspireConformityDegree}}</gco:CharacterString>
                            </gmd:explanation>
                            <gmd:pass>
    ...
    (3, 'FGDC Metadata', 'FGDC metadata template for spatial data', 'FGDC', '1998', 'FGDC', '<?xml version="1.0" encoding="UTF-8"?>
<metadata>
    <idinfo>
        <citation>
            <citeinfo>
    ...
    (4, 'OGC CSW Metadata', 'OGC CSW metadata template for spatial data', 'ISO19115', '2.0.2', 'OGC-CSW', '<?xml version="1.0" encoding="UTF-8"?>
...
ON CONFLICT (id) DO UPDATE SET
    ...
    metadata_standard = EXCLUDED.metadata_standard,
