...
/* login.twig */
class __TwigTemplate_2625bcc9db80c6232e457b27656ed3a2 extends Template
{
    ...
    {
        $macros = $this->macros;
        yield "Login - GIS Metadata Portal";
        yield from [];
    }
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 6
        yield "<div class=\"flex justify-center items-center\">
    <div class=\"w-full max-w-md\">
        ...
        if ((($tmp = ($context["error"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 15
            yield "                <div class=\"mb-6 bg-red-50 border-l-4 border-red-400 p-4\">
                    <div class=\"flex\">
...
";
    ...
    {
        return array (  100 => 28,  92 => 23,  82 => 15,  80 => 14,  70 => 6,  63 => 5,  52 => 3,  41 => 1,);
    }
...
{% block title %}Login - GIS Metadata Portal{% endblock %}
...
{% endblock %} ", "login.twig", "/var/www/novella/templates/login.twig");
    }
}
